...
final class GeneralViewModel: GeneralViewModelProtocol {
    ...
    private func setupMockObjects() {
        articles = [
            ArticleCellViewModel(article: ArticleResponceObject(title: "First object", description: "First object description in the mock object", urlToImage: "...", date: "23.01.2005"))
        ]
    }
}
